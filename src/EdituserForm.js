...
function EditUser(props) {
  ...
  // const InitialState={id:null,firstName:'',lastName:'',email:'',phnnum:null,address1:'',address2:'',state:'',country:''}
  const [getData, setgetda] = useState(props.current);
  console.log(getData);

  useEffect(() => {
    setgetda(props.current)
  }, [props])
      ...
      <div className='FormDiv1'>
        ...
        <form name='form1' className='form1' onSubmit={
          event => {
            ...
            props.updateUser(getData.id, getData);
            navigate("/table");
          }
        }>
